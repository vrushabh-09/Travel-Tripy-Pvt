...
graph TB
    ...
    B --> C[AI Agent Coordinator]
    C --> D[Research Agent]
    C --> E[Budget Agent]
    C --> F[Itinerary Agent]
    C --> G[Local Experiences Agent]
    D --> H[Gemini AI]
    E --> I[Groq API]
    F --> I
    G --> I
...
- ![Groq API](https://img.shields.io/badge/Groq_API-00A98F?style=flat)
- ![OpenTripMap](https://img.shields.io/badge/OpenTripMap-FF6B35?style=flat)
...
[![Star History Chart](https://api.star-history.com/svg?repos=vrushabh-09/travel-tripy&type=Date)](https://star-history.com/#vrushabh-09/travel-tripy&Date)
